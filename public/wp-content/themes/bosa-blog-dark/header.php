...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-blog-dark' ); ?></a>

	<?php if( get_theme_mod( 'header_layout', 'header_three' ) == '' || get_theme_mod( 'header_layout', 'header_three' ) == 'header_one' ){
		get_template_part( 'template-parts/header/header', 'one' );
	}elseif( get_theme_mod( 'header_layout', 'header_three' ) == 'header_two' ){
		get_template_part( 'template-parts/header/header', 'two' );
	}elseif( get_theme_mod( 'header_layout', 'header_three' ) == 'header_three' ) {
