...
<?php if ( !(cutemag_get_option('hide_search_results_heading')) ) { ?>
<div class="cutemag-page-header-outside">
<header class="cutemag-page-header">
<div class="cutemag-page-header-inside">
<?php if ( cutemag_get_option('search_results_heading') ) : ?>
<h1 class="page-title"><?php echo esc_html( cutemag_get_option('search_results_heading') ); ?> <span><?php echo esc_html(get_search_query()); ?></span></h1>
<?php else : ?>
<h1 class="page-title"><?php esc_html_e( 'Search Results for:', 'cutemag' ); ?> <span><?php echo esc_html(get_search_query()); ?></span></h1>
<?php endif; ?>
</div>
</header>
</div>
