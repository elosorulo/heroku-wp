...
class Dark_Press_Customizer_Loader extends Dark_Press_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'darkpressColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new Dark_Press_Customizer_Loader();
