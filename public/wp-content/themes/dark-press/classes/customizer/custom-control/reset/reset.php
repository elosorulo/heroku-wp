...
* @since 1.0.0
*
* @package Darkmag WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Dark_Press_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( Dark_Press_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'dark-press' )
            ));
        }
...
Dark_Press_Customizer::add_custom_control( array(
    ...
    'class'    => 'Dark_Press_Customizer_Reset',
    'sanitize' => false,
