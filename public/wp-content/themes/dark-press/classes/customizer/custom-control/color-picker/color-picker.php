...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Dark_Press_Customizer_Color_Control extends WP_Customize_Control {

		public $type = 'dark-press-color-picker';
		...
		public function enqueue() {
			wp_enqueue_script( 'wp-dark-press-color-picker' );
			wp_enqueue_style( 'wp-dark-press-color-picker' );
		}
...
Dark_Press_Customizer::add_custom_control( array(
    ...
    'class'    => 'Dark_Press_Customizer_Color_Control',
    'sanitize' => array( 'Dark_Press_Customizer', 'sanitize_rgba' ),
));