...
if( !class_exists( 'Dark_Press_Customizer_Dimensions_Integration' ) ){

	class Dark_Press_Customizer_Dimensions_Integration extends Dark_Press_Customizer{
		...
		public static $type = 'dark-press-dimensions';

		public static $class = 'Dark_Press_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'dark-press' );
	...
	new Dark_Press_Customizer_Dimensions_Integration();
}
