...
class Dark_Press_Customizer_Dimensions_Control extends WP_Customize_Control {
	 ...
	 * @package Dark Press WordPress Theme
	 */
	public $type = 'dark-press-dimensions';
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'dark-press' );
	...
	protected function content_template() {
		...
		<ul class="desktop control-wrap active">
	        ...
	        <li class="dimension-wrap">
	            <div class="link-dark-press-dimensions">
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'dark-press' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'dark-press' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'dark-press' ),
			'desktop_left' 		=> esc_html__( 'Left', 'dark-press' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'dark-press' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'dark-press' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'dark-press' ),
			'tablet_left' 		=> esc_html__( 'Left', 'dark-press' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'dark-press' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'dark-press' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'dark-press' ),
			'mobile_left' 		=> esc_html__( 'Left', 'dark-press' 	),
		);
		if ( false === $id ) {
