<?php
/**
 * Customizer Control: dark-press-buttonset.
 *
 * @since   1.0.0
 *
...
if ( class_exists( 'WP_Customize_Control' ) ){
	class Dark_Press_Customizer_Buttonset_Control extends WP_Customize_Control {
		 ...
		 * @package Dark Press WordPress Theme
		 */
		public $type = 'dark-press-buttonset';
		...
		protected function content_template() {
			...
			<# } #>
			<div id="input_{{ data.id }}" class="dark-press-buttonset">
...
Dark_Press_Customizer::add_custom_control( array(
    ...
    'class'    => 'Dark_Press_Customizer_Buttonset_Control',
