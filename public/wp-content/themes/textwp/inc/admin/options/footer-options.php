...
function textwp_footer_options($wp_customize) {
    ...
    // Customizer Section: Other
    $wp_customize->add_section( 'textwp_section_other_options', array( 'title' => esc_html__( 'Other Options', 'textwp' ), 'panel' => 'textwp_main_options_panel', 'priority' => 600 ) );

    $wp_customize->add_setting( 'textwp_options[enable_widgets_block_editor]', array( 'default' => false, 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'textwp_sanitize_checkbox', ) );

    $wp_customize->add_control( 'textwp_enable_widgets_block_editor_control', array( 'label' => esc_html__( 'Enable Gutenberg Widget Block Editor', 'textwp' ), 'section' => 'textwp_section_other_options', 'settings' => 'textwp_options[enable_widgets_block_editor]', 'type' => 'checkbox', ) );
